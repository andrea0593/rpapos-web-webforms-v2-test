<%@ Page Title="" Language="C#" MasterPageFile="~/Core.Master" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="rpapos_web_webforms.Home" %>
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content no-padding">
                        <div class="flot-chart m-t-lg" style="height: 55px;">
                            <div class="flot-chart-content" id="flot-chart1" style="padding: 0px; position: relative;"><canvas class="flot-base" width="477" height="55" style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 477px; height: 55px;"></canvas><canvas class="flot-overlay" width="477" height="55" style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 477px; height: 55px;"></canvas></div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div><iframe class="chartjs-hidden-iframe" style="width: 100%; display: block; border: 0px; height: 0px; margin: 0px; position: absolute; left: 0px; right: 0px; top: 0px; bottom: 0px;"></iframe>
                                        <canvas id="lineChart" height="166" width="437" style="display: block; width: 437px; height: 166px;"></canvas>
                                    </div>
                                </div>
                                <div class="col-md-4">
